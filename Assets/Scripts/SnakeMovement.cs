    ...
    public void Move()
    {
        ...
        else if (Input.GetMouseButtonDown(0))
        {
            if (BodyParts.Count > 0 && Mathf.Abs(BodyParts[0].position.x) < maxX)
            {
                ...
                BodyParts[0].GetComponent<Rigidbody>().AddForce(Vector3.right * rotationSpeed * deltaMousePos * -sign); //замена Ригидбади2д на просто ригидбоди и вектор2 на вектор3
